#compared to goforward5, the robot goes back "only" when it detacted the obstacle in front of it
...
class GoForward6():
	...
	def control(self):
		...
		for degree, x in enumerate(self.ranges):
			if (x < 0.15 and x > 0.01 and degree <60) or (x < 0.15 and x > 0.01 and degree >300):
